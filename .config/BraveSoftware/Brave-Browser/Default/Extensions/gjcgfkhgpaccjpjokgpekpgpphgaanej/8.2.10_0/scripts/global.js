...
function init_configuration() {
    ...
    cfg_order['storage'] = 0;
    cfg_order['settings'] = 0;
    cfg_order['recommendations'] = 0;
    cfg_order['debug'] = 0;
    ...
    var conf = {
        ...
        'moviesRecommendations' : {
            ...
            'access' : false,
            'order' : cfg_order['recommendations']++,
            'val' : null,
            'def' : null,
            'min' : null,
            'max' : null,
...
function updateRecommendations() {
    chrome.storage.local.get('recommendations', (storedRecommendations) => {
        if (storedRecommendations.recommendations &&
            storedRecommendations.recommendations.created_at &&
            storedRecommendations.recommendations.created_at > Date.now() - (24 * 60 * 60 * 1000)) {
