                    ...
                    if ((next_is_offered && !loading_next_title) || forceNextEpisode) {
                        ...
                        if (cfg['titleEndAction']['val'] == 'skip' || forceNextEpisode) {
                            if (nextVideo != '' || (nextVideo == '' && next_no_wait)) {
                                ...
                                let button_back_to_browse = document.querySelector('[data-uia="postplay-back-to-browse"]') // -R
                                if (((!check_series() && cfg['nextEpisodeStopMovies']['val']) || (check_series() && cfg['nextEpisodeStopSeries']['val'])) && currentVideo != nextVideo) {
                                    ...
                                    if (button_exit_player_obj) {
                                        ...
                                        console.log('old button click')
                                    } else if (button_back_to_browse) {
                                        button_back_to_browse.click()
                                ...
                                // fix -R
                                const next_episode_button_obj = document.querySelector('[data-uia="next-episode-seamless-button"]')
                                if (cfg['nextEpisodeStopSeries']['val'] && !next_episode_button_obj) {
                                    button_back_to_browse.click()
                                    console.log('new button click')
                                }
