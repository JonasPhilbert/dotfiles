function object_handler(object_category, related_object) {
    ...
    switch (object_category) {
        ...
        case 'button_skip_recap':
            let obj1 = document.querySelector('[data-uia="player-skip-recap"]')
            let obj2 = document.querySelector('[data-uia="player-skip-preplay"]')
            if (obj1) {
                obj = obj1
            } else if (obj2) {
                obj = obj2
            }
            // obj = document.querySelector('[data-uia="player-skip-recap"]'); // -R added option for new skip preplay btn
