...
function stop_worker(worker) {
    if (workers[worker]) {
        try { clearInterval(workers[worker]); } catch (e) { console.log(e) }
        try { clearTimeout(workers[worker]); } catch (e) { console.log(e) }
...
function environment_update() {
    try {
        ...
        debug_variables['api'] = {};
        debug_variables['showRecommendations'] = {};
        debug_variables['moviesRecommendations'] = {};
        debug_variables['tvSeriesRecommendations'] = {};
        ...
        debug_variables['showRecommendations']['showRecommendations'] = cfg['showRecommendations']['val'];
        debug_variables['moviesRecommendations']['moviesRecommendations'] = cfg['moviesRecommendations']['val'];
        debug_variables['tvSeriesRecommendations']['tvSeriesRecommendations'] = cfg['tvSeriesRecommendations']['val'];
